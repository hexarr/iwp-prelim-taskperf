...
echo '<style type="text/css">
        ...
        .what-i-do .item, .portfolio__items .item .image, .side__contact div .icon{
        ...
        .side .side__switch .active{
          background-color: #d9d9d9;
        }
        .side .side__switch .active a{
          font: weight 800;
        }
        </style>';
?>
      ...
      <div class="what-i-do">
        ...
        <div class="what-i-do__items">
          ...
          foreach ($info[$name]['what-i-do'] as $x) {
            ...
            } else if ($x[$do_title] == "Typescript") {
              $icon_text = "fa-brands fa-square-js";
            } else if ($x[$do_title] == "UX Design") {
              $icon_text = "fa-solid fa-cubes";
            } else if ($x[$do_title] == "Databases") {
              $icon_text = "fa-solid fa-server";
            } else {
              $icon_text = strtolower("fa-brands fa-$x[$do_title]");
            }
